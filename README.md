...
For the full local runbook, environment variables, curl examples, wallet-vs-token dashboard workflow, dashboard `Failed to fetch` troubleshooting, and Solana RPC `HTTP 429` rate-limit tuning, see [`docs/realtime-pipeline.md`](docs/realtime-pipeline.md).
